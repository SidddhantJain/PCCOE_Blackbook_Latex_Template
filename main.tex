...
% -------------------------
% Heading style (BTech layout)
% -------------------------
\titleformat{\chapter}{\centering\bfseries\LARGE}{\thechapter.}{1em}{}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\textbf{\ProjectTitle}}
\fancyfoot[C]{\CollegeName\ - INFORMATION TECHNOLOGY - \AcademicYear\\\thepage}
